...
func (s *ReadyState) DispenseProduct() {
	fmt.Println("Please make payment first as insufficient amount. Current Total Amount is ", s.vendingMachine.totalPayment)
}
...
func (s *DispenseState) DispenseProduct() {
	fmt.Println("Total Payment Done :", s.vendingMachine.totalPayment)
