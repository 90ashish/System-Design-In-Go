...
2.2 Resource Sizing
    ...
    For a given RPS: estimate CPU cycles, memory per request, disk I/O, and network bandwidth needed.
...
11. Observability & Monitoring
    ...
    Health Checks & Heartbeats: Automatic remove unhealthy instances from load-balancer.
