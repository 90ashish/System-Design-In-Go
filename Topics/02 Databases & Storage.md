...
### B-Tree Indexes
- **How it works**: Balanced tree of key pointers; good for range scans (e.g., `WHERE age BETWEEN 20 AND 30`).
...
### Hash Indexes
- **How it works**: Hash table under the hood; excellent for exact matches (e.g., `WHERE id = 123`).
